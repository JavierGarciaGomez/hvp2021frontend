    ...
    <Fragment>
      ...
      <section className="bg-primary--ti-er section-pb">
        <div className="container">
          ...
          <div className="mp-service__services">
            <div className="mp-service__service bg-primary--sh-er">
              <div className="mp-service__img">
              ...
              <div className="mp-service__content">
                ...
                <div className="d-flex justify-content-center">
                  <Link className="" to="consultation">
                    <button
                      type="button"
            ...
            <div className="mp-service__service bg-primary--sh-st">
              <div className="mp-service__img">
              ...
              <div className="mp-service__content">
                <h3> Vacunas </h3>
                <p>
                  El plan de vacunación de las mascotas es de vital importancia
            ...
            <div className="mp-service__service bg-primary--sh-er">
              ...
              <div className="mp-service__content">
                <h3> Laboratorio </h3>
                <p>
                  Para servicios de diagnóstico clínico contamos con pruebas de
            ...
            <div className="mp-service__service bg-primary--sh-er">
              ...
              <div className="mp-service__content">
                ...
                <div className="d-flex justify-content-center">
                  <Link className="" to="insemination">
                    <button
                      type="button"
                      className="mainPages-button mainPages-button--sm--light"
                    >
            ...
            <div className="mp-service__service bg-primary--sh-st">
              <div className="mp-service__img">
                <img src="assets/imgs/mainPage/services/profilax.jpg" alt="" />
              </div>
              <div className="mp-service__content">
            ...
            <div className="mp-service__service bg-primary--sh-st">
              <div className="mp-service__img">
                <img src="assets/imgs/mainPage/services/microchip.jpg" alt="" />
              </div>
              <div className="mp-service__content">
                <h3> Microchip internacional </h3>
                <p>
                  En muchos países es obligatorio que los perros cuenten con un
            ...
            <div className="mp-service__service bg-primary--sh-er">
              <div className="mp-service__img">
                <img src="assets/imgs/mainPage/services/catarata.jpg" alt="" />
              </div>
              <div className="mp-service__content">
                <h3> Cirugía de cataratas </h3>
                <p>
                  Somos un referente en el sureste mexicano en oftalmología y en
                  cirugía de cataras, debido a que contamos con equipamiento de
                  vanguardia y profesionales en esta área médica.
                </p>
                <div className="d-flex justify-content-center">
                  <Link className="" to="cataractSurgery">
                    <button
                      type="button"
                      className="mainPages-button mainPages-button--sm--light"
                    >
