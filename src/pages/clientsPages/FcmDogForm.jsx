...
let formValidation = Yup.object().shape({
  ...
  owner: Yup.string().trim().required("Es obligatorio"),
...
export const FcmDogForm = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    const { sex, number, suburb, postalCode, city, state, country } = values;
    values.address = {
      sex,
      number,
      suburb,
        ...
        <Form>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={4}>
              <TextFieldWrapper name="petName" label="Nombre (s)*" />
            </Grid>
            <Grid item xs={12} md={4}>
              <TextFieldWrapper name="breed" label="Apellido paterno*" />
            </Grid>
            <Grid item xs={12} md={4}>
              <TextFieldWrapper name="color" label="Apellido materno*" />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextFieldWrapper name="registerNum" label="Número de socio*" />
            </Grid>{" "}
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12} md={3}>
              <TextFieldWrapper name="sex" label="Calle" />
            </Grid>
            <Grid item xs={12} md={3}>
