...
export const PackagePrintLitter = () => {
  ...
  useEffect(() => {
    ...
    const fcmPartnerMaleOwner = allFcmPartners.find((element) => element._id === steps[0].dataId);
    const fcmPartnerFemaleOwner = allFcmPartners.find((element) => element._id === steps[1].dataId);
    const fcmDogMale = allFcmDogs.find((element) => element._id === steps[2].dataId);
    const fcmDogFemale = allFcmDogs.find((element) => element._id === steps[3].dataId);
  ...
  return (
    ...
    <Box sx={{ padding: "3rem" }}>
      ...
      {!isObjectEmpty(breedingFullData) && <FcmPrintPackageBreedForm breedingData={breedingFullData} />}
      <div className="u-pagebreak" />
